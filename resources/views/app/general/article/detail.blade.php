            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row mb-4">
                        ...
                        <label
                            class="col-form-label text-md-left col-12 col-md-3 col-lg-3">{{$article['title']}}</label>
                    </div>
                    <div class="form-group row mb-4">
                        ...
                        <label class="col-form-label text-md-left col-12 col-md-3 col-lg-3">{{$article['category']['category']}}</label>
                    </div>
                    <div class="form-group row mb-4">
