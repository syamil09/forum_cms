...
@section('title','Forum | Master Menu')
...
@section('section_header')
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('master-menu.index') }}">Master Menu</a></div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Master Menu</h4>
                </div>
                <div class="card-body">
                    <form id="createVote" method="POST" action="{{  route('master-menu.update', $Menu['id']) }}">
                        @csrf
                        <input type="hidden" name="_method" value="PATCH">
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name</label>
                            <div class="col-sm-12 col-md-7">
                                <input name="name" type="text" class="form-control" required value="{{ $Menu['name'] }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Url</label>
                            <div class="col-sm-12 col-md-7">
                                <input name="url" type="text" class="form-control" required value="{{ $Menu['url'] }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <button id="btnSubmit" class="btn btn-primary">Update Master Menu</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@section('script_page')
    ...
    $('.select2-icon').val("{!! $Menu['group_id'] !!}").trigger('change');
    $('#createVote').valid();
    </script>
@endsection
